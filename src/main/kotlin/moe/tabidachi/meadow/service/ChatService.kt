...
interface ChatService {
    ...
    /** 发送消息（入库 + WebSocket 广播）；type: chat / announcement */
    suspend fun sendMessage(callerId: Long, serverId: Long, content: String, type: String = "chat"): Response<ChatMessageInfo?>
